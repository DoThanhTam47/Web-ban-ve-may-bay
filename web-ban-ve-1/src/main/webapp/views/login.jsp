...
<body>
	<body style="background: -webkit-radial-gradient(rgb(15, 14, 16), rgb(5, 11, 18));background: radial-gradient(rgb(12, 11, 12), rgb(5, 11, 18));height:100%; min-height:100%;margin:0;padding:0;" >
	<header>         
	<!--Navigation Bar-->
	...
	<!-- Top content -->
        <div class="top-content" style="background:url('template/assets/img/sign.jpg');height:100%; min-height:100%;margin:0;padding:0;">
                        	...
                        	<div class="form-box" style='margin-bottom: 10%;'>
	                            ...
	                            <div class="form-bottom" style="color:white;">
				                    <form role="form" action="login" method="post" class="login-form">
				                        ...
				                        <button style="margin-top:5%;" type="submit" class="btn">ĐĂNG NHẬP</button>
				                    </form>
			                    </div>
		                    </div>		            
                        </div>
	...
	<!-- FOOTER -->
		<footer class="text-center" style="color:white;background:url('<c:url value='template/assets/img/dashboard.jpg' />'); margin-bottom:0px; margin-top:4px; padding-top:3%; padding-bottom:4px; border-top:2px solid black;">
